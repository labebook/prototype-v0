export default function SDSPAGETheoryPage() {
  return (
    <>
      ...
      <div className="flex flex-wrap mb-8">
        <div className="w-2/3 pr-4">
          <div className="w-full h-[300px] overflow-hidden rounded-lg">
            <img
              src="/images/sds-page-electrophoresis-diagram.jpg"
              alt="SDS-PAGE Gel Electrophoresis Diagram showing the separation of proteins by molecular weight through polyacrylamide gel matrix"
      ...
      <div className="py-4">
        <p>
          Sodium Dodecyl Sulfate Polyacrylamide Gel Electrophoresis (SDS-PAGE) is a technique used to separate proteins
